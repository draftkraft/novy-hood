...
class ProjectConfigurationTests(unittest.TestCase):
    ...
    def test_activity_log_has_startup_update_and_radio_diagnostics(self):
        ...
        self.assertIn("normalizeMqttHost(", hood)
        self.assertIn("normalizeMqttPort(", hood)
        self.assertIn('logMsg("MQTT: normalized broker address");', hood)
        ...
        self.assertIn('String mqttBase() { return mqttPrefix; }', hood)
        self.assertIn("String mqttStateHint(int state)", hood)
        self.assertIn('Topics: <code>&lt;prefix&gt;/button/&lt;id&gt;/set</code>', hood)
        ...
        self.assertIn("bad credentials - check username/password", hood)
